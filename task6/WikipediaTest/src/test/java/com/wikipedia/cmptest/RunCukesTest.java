...
public class RunCukesTest {
    ...
    public static void setUp() {
        // ExtentCucumberFormatter x = new ExtentCucumberFormatter(new File("src/test/resources/extent-config.xml"));
        ExtentCucumberFormatter.initiateExtentCucumberFormatter(new File("reports/index.html"));
        ExtentCucumberFormatter.loadConfig(new File("src/test/resources/extent-config.xml"));
        ExtentCucumberFormatter.addSystemInfo("Application URL", "hello");
    }
}